...
describe('utils', () => {
  describe('#saveCurrentProperty', () => {
    it('should store property properly for furture restoration', () => {
      ...
      // saveCurrentProperty(el4, 'b.c.d', -1);
      // expect(el4).toEqual({
      //   __fab_b_c_d__: -1,
      //   a: 1,
      //   b: {
